...
Declare @Proficency As Table (Prof_Name char(20), Prog_count Int );
Insert into @Proficency 
Select 
	Prof1,
	Count(*)
...
Select 
	Pro.Prof_Name,
	Sum(Pro.Prog_count) #Programer , 
	Count(Software.Developin) #Packages

From @Proficency as Pro Join Software
on Pro.Prof_Name = Software.Developin
Group By Pro.Prof_Name
